...
** Les fichiers de l'agenda
   #+begin_src emacs-lisp
     ...
     (setq org-agenda-files-cours
           (list* "~/org/cours.org" "~/org/edt.org"
     ...
     (setq org-agenda-files
           (append '("~/org/sante.org")
                   org-agenda-files-floss
...
#+begin_src emacs-lisp
  ...
  (defvar note-for-org-mode-map
    (let ((map (make-sparse-keymap)))
      (define-key map (kbd "n") 'helm-find-student)
      (define-key map (kbd "RET") 'helm-find-student)
